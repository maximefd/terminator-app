...
- **Mesures sur le VPS** ([#124](https://github.com/maximefd/terminator-app/issues/124),
  [ADR 0013](docs/adr/0013-cible-hebergement-production.md)) : `load_profile.py` sur le serveur de production. Le
  VPS est 2 à 2,5 fois plus lent que le Mac ; la RAM reste loin du seuil (35 %), le p95 global est à 14,96 s, et
  les grands formats comme les mots imposés touchent le budget de 20 s. Proposition : rester sur le VPS-1.
