...
| CORS | Liste exacte d'origines (`CORS_ORIGINS`), avec credentials puisque la session voyage en cookies ([ADR 0015](adr/0015-session-en-cookies.md)) ; `*` refusé en production | `backend/app.py` |
