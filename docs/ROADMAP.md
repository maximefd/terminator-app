...
| 3 — Moteur avec mots imposés | 🚧 redémarrages (#19) et index des candidats (#20) : 20/20 sur chaque layout du benchmark ; contrat de génération proposé ([ADR 0007](adr/0007-contrat-de-generation.md), #16) ; restent les mots obligatoires et souhaités (#17, #18) |
...
- **Écran de génération** : choix du layout avec aperçus, saisie des mots, sélection des dictionnaires thématiques, progression, grille avec source des mots colorée, ratio, régénérer / rejouer un seed.
- **Sauvegarde des grilles** : modèle `Grid` + migrations Alembic + historique.
