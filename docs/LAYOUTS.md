...
Formats disponibles aujourd'hui : **6×7** (5 layouts), **7×9** (1), **11×6** (1), **10×13** (6) et **13×16** (1). L'API les liste via `GET /api/grids/formats`, et le frontend ne propose que ceux-là.
